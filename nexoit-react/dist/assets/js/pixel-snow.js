(function() {
  ...
  function initPixelSnow(container, options) {
    ...
    var flakeSize = options.flakeSize || 0.01;
    var minFlakeSize = options.minFlakeSize || 1.25;
    var pixelResolution = options.pixelResolution || 200;
    var speed = options.speed || 1.25;
    var depthFade = options.depthFade || 8;
    var farPlane = options.farPlane || 20;
    var brightness = options.brightness || 1;
    var gamma = options.gamma || 0.4545;
    var density = options.density || 0.3;
    var variant = options.variant || 'snowflake';
    var direction = options.direction || 125;

    var variantValue = variant === 'round' ? 1.0 : variant === 'snowflake' ? 2.0 : 0.0;

    var renderer, scene, camera, material, geometry;
    var animationId;
    var startTime;
