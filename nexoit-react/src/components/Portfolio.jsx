...
const ProjectCard = React.memo(({ project }) => (
  <article className="pcard animate-on-scroll" data-category={project.category}>
    <a className="pcard__media" href={project.link} aria-label={`Ver descripción: ${project.title}`}>
    ...
    <div className="pcard__body">
      ...
      <div className="pcard__actions">
        <a className="btn btn--sm" href={project.link}>
