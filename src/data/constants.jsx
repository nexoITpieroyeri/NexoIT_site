...
export const SERVICES = [
  {
    ...
    description: 'Landing pages, portafolios, catálogos y ecommerce con diseño moderno, responsive y SEO.',
...
export const PLANS = {
  web: [
    ...
    },
    {
      ...
      features: [
        ...
        'Pasarela de pagos (Yape, Stripe y más)',
  ...
  sistemas: [
    ...
    },
    {
      tag: 'Plataforma SaaS',
      name: 'SaaS Completo',
      description: 'Plataforma multiusuario con suscripciones o gestión avanzada.',
      price: '$550',
      ...
      features: [
        ...
        'Módulos a medida (CRM, reservas y más)',
